...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddEntry_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddEntry_t qt_meta_stringdata_AddEntry = {
    {
QT_MOC_LITERAL(0, 0, 8), // "AddEntry"
QT_MOC_LITERAL(1, 9, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "AddEntry\0on_buttonBox_accepted\0"
};
...
const QMetaObject AddEntry::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddEntry.data,
      qt_meta_data_AddEntry,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddEntry::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddEntry.stringdata0))
